...
export const addUser = (data, cookie) => (dispatch) => {
  ...
  axios
    .post(
      ...
      "https://easytrendapi.herokuapp.com/api/v1/users",
      { withCredentials: true, crossDomain : true },
      { headers: {'Access-Control-Allow-Origin': '*', 'Content-Type': 'application/json', 'X-CSRF-Token': cookie}},
      { user: data },
    )
  // fetch("https://easytrendapi.herokuapp.com/api/v1/users", {
  //   method: "POST",
  //   headers: {
...
export const loginUser = (data) => (dispatch) => {
  ...
  axios
    .post(
      ...
      "http://easytrendapi.herokuapp.com/api/v1/sessions/login",
      { user: data },
...
export const logoutUser = (data) => (dispatch) => {
  axios
    .delete(
    	...
    	"http://easytrendapi.herokuapp.com/api/v1/sessions/logout",
    	{ withCredentials: true })
    .then((response) => {
