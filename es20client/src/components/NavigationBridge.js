...
class NavigationBridge extends Component {
  ...
  componentWillMount() {
    console.log('NavigationBridge componentWillMount this.props', this.props);
    console.log('NavigationBridge componentWillMount this.state', this.state);
  }
  componentDidMount() {
  ...
  setUserObject(user_in_app_state) {
    console.log('setting user object NavigationBridge', user_in_app_state);
    this.setState({ user_in_app_state: user_in_app_state });
  }
  navigateScreen(screen) {
    console.log('screen NavigationBridge', screen);
    if (screen) {
      console.log('screen present', screen)
      return <NavigateToScreen screen={"homescreen"} />;
    }
  }
  render() {  
    return (
